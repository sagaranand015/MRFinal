	        	...
	        	<?php 
					...
					if(isset($_FILES["fileAssignmentSolution"]) && $_FILES["fileAssignmentSolution"]["error"]== UPLOAD_ERR_OK)
					{
						...
						if($assId == "-1" || $assCourse == "-1" || $assPdf == "-1" || $assNo == "-1" || $email == "-1" || $id == "-1") {
							...
							echo "<h3 class='page-header'>Upload failed</h3><p>Looks like the parametere for solution upload are not correct. Please try again or contact us at: <code>tech@mentored-research.com</code></p>";
						}
						else {
