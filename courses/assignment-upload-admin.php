	        ...
	        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 main-div upload-div">
	        	...
	        	<?php 
                    ...
                    if(isset($_FILES["fileAssignmentPDF"]) && $_FILES["fileAssignmentPDF"]["error"]== UPLOAD_ERR_OK)
                    {
                        ...
                        $fileName           = strtolower($_FILES['fileAssignmentPDF']['name']);
                        ...
                        $courseId = "-1";
                        $assId = "-1";
                        if(isset($_POST["course-list-assPDF"])) {
                            $courseId = $_POST["course-list-assPDF"];
                        }
                        if(isset($_POST["assignment-list-assPDF"])) {
                            $assId = $_POST["assignment-list-assPDF"];
                        }
                        ...
                        if($courseId == "-1" || $assId == "-1") {
                            ...
                            if(move_uploaded_file($_FILES['fileAssignmentPDF']['tmp_name'], $uploadDirectory.$newFileName )) {
                                ...
                                $register = RegisterAssignmentPDF($assId, $courseId, $uploadDirectory.$newFileName);
                                if($register == "1") {
                                    echo "<h3 class='page-header'>Upload Success</h3><p>Your Assignment PDF upload is successful.</p>";
                                }
                                else {
