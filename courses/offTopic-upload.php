...
if(isset($_FILES["fileAssignmentOffTopic"]) && $_FILES["fileAssignmentOffTopic"]["error"]== UPLOAD_ERR_OK)
{
	...
	*/
	...
	if ($_FILES["fileAssignmentOffTopic"]["size"] > 5242880) {
		die("File size is too big!");
	}
	
	//allowed file type Server side check
	switch(strtolower($_FILES['fileAssignmentOffTopic']['type']))
		{
			//allowed file types
			case 'image/png': 
			case 'image/gif': 
	...
	$File_Name          = strtolower($_FILES['fileAssignmentOffTopic']['name']);
