	        ...
	        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 main-div upload-div">
	        	...
	        	<?php 
                    ...
                    if(isset($_FILES["fileAddMentor"]) && $_FILES["fileAddMentor"]["error"]== UPLOAD_ERR_OK)
                    {
                        ...
                        $fileName           = strtolower($_FILES['fileAddMentor']['name']);
                        ...
                        if(isset($_POST["add-mentor-excel-course"])) {
                            $course = $_POST["add-mentor-excel-course"];
                        }
                        if(isset($_POST["add-mentor-excel-organ"])) {
                            $organ = $_POST["add-mentor-excel-organ"];
                        }
                        ...
                        if($organ == "-1" || $course == "-1") {
                            ...
                            if(move_uploaded_file($_FILES['fileAddMentor']['tmp_name'], $uploadDirectory.$newFileName)) {
                                ...
                                try {
                                    ...
                                    echo "<h3 class='page-header'>Upload Success</h3><p>Your Mentor Excel upload is successful. " . $response . "</p>";                                    
                                } 
                                catch (Exception $e) {
